...
# *************************************************************************
# Jon Sadler Sept 2013 updated Jan 2021 [updated 15 th Sept 2022 for github]
...
# we could do this the hard way and use the repeat and sequencing tools to sort it then align it but
# I am a fan of easier fixes.

# We can combine it directly in a table, by binding these values into a data file of sorts
BirdData2 <- cbind(Wingcrd, Tarsus, Head, Wt)
BirdData2   # See product of your labour. A data file!

# if you click on the "BirdData2" object in the Environment tab [above right window]
# it will open as a tab in this window. Looks familiar doesn't it?!

# As is always the case, you can code this action using:
View(BirdData2)
#Notice this is one of the few occasions where the function call has an uppercase letter
# it is 'View' not 'view'. This is because it was uniquely created for RStudio.
#This highly unusual all R functions start with lowercase letters (e.g. mean, sd)
#Notice this uses an uppercase letter for function call. That is because is in an RStudio function.
# All R functions start with lowercase E.g. mean, sd and so on.
...
# Why do it? Because you've learned some very important functions 'c', and  'cbind' are three of my favourites (but check 'rbind')
...
# data organised in longer vector with a unique identifier is needed for others (known as long format), such as T-test, ANOVA, linear regression 
# and graphing tools like xyplot in the lattice package. We'll looks at ways of doing this in R later (using ddplyr and tidyr).
...
# Look the environment tab again it's added a blue arrow symbol and it tells you how
# many observations (=rows) and variables (=columns) you have in the dataframe
# Now click on the blue arrow.This shows your column data and the column name

# *************************************************************************
# IN FACT YOU'LL USE DATAFRAMES ALMOST TO THE EXCLUSION OF OTHER DATATYPES*
# BUT R also stores data.tables and things called tibbles                 *
#**************************************************************************
