...
# ******************************************************************************
# Jon Sadler March 2016 - FULL SCRIPT FOR ME! updated April 27th 2021
...
# Plot residual - repeated for autoplot fans
autoplot(beach.lm1)
...
# Best model leaves us with fExp and NAP as explanatory variables
# We really should refit the model with these two variables and plot the results
# You can try this at your leisure...
...
# Have a look by stripping out the residuals and plotting them against the explanatories. You've done this before with linear models.
# There are issues in terms of residual spread with the explanatory variables
...
mcp.fnc(model7)                            # Provides a QQ plot and heteroscedasticity plot
